...
df = st.cache(pd.read_csv)("E:/creditcard.csv/creditcard.csv")
...
if st.sidebar.checkbox("Show info of missing values"):
    ...
    st.write("It can be seen that our dataset contains no null values",df.isna().sum() )
...
if st.sidebar.checkbox("Statistics of Valid and Fraud transactions"):
    ...
    st.pyplot(fig)
    st.write("The number of fraud transactions are very very low compared to valid transactions. We can see our dataset is highly imbalanced.")
